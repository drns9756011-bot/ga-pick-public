          ...
          <div class="privacy-policy-body">
              ...
              <div class="privacy-policy-table-wrap">
                <table class="privacy-policy-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>가전 구독관 상담</td>
                      <td>성함, 휴대전화번호, 설치 지역, 상담 희망 시간, 선택 제품·모델·옵션, 추가 요청사항, 인증·동의 기록</td>
                      <td>구독 상담 접수, 제휴 상담업체 연결, LG전자 구독 계약·배송·설치 진행</td>
                      <td>개인정보 보호법 제15조 제1항 제1호 및 제17조 제1항 제1호</td>
                    </tr>
                    <tr>
                      <td>판매 매니저 등록·이용</td>
            ...
            <article class="privacy-policy-section">
              ...
              <ul>
                ...
                <li><strong>가전 구독관 상담 정보:</strong> 픽견적은 상담 접수일로부터 90일 또는 동의 철회 시까지 보관합니다. 제휴 상담업체 및 LG전자는 상담 미진행 시 제공일로부터 30일, LG전자 구독 계약 체결 시 계약 및 관계 법령상 의무 이행에 필요한 기간 동안 처리합니다.</li>
                ...
                <li><strong>고객 견적 삭제:</strong> 고객 견적을 삭제하면 해당 견적의 고객정보, 인증기록, 이미지, 제안·후기, 상담·메시지 및 발송 대기·처리 기록을 별도 삭제 이력 없이 복구할 수 없도록 삭제합니다.</li>
              </ul>
            ...
            <article class="privacy-policy-section">
              ...
              <ul>
                ...
                <li><strong>가전 구독관 상담:</strong> 고객이 선택한 제품·모델·옵션과 상담 정보를 픽견적 제휴 상담업체 및 LG전자에 제공할 수 있습니다. 제공 목적은 상담 연결, LG전자 구독 계약 체결, 배송·설치 및 계약 관련 고객 응대이며 상담 신청 화면에서 별도 동의를 받습니다.</li>
              </ul>
